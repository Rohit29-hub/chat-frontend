...
const App = () => {
  ...
  useEffect(() => {
    ...
    socket.on("message", (newMessage) => {
      console.log(`message from this client ${newMessage.id} to server: `, newMessage.message);
        ...
        <div className="message-box">
          {messageFromServer.map((message, index) => (
            <div style={{
              ...
              display: 'flex',
              alignItems: 'center',
              justifyContent:`${message.id == myId ? 'flex-start': 'flex-end'}`,
              marginTop: '10px'
              ...
              <div style={{
                ...
                <img style={{
                  ...
                  height: '100%',
                  objectFit: 'cover'
                }} src={`${message.id == myId ? user1Img : user2Img} `} alt="error" />
              </div>
